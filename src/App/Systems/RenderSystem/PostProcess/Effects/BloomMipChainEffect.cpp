...
namespace Ailurus
{
    const std::string BloomMipChainEffect::EFFECT_NAME = "BloomMipChain";
    const char* BloomMipChainEffect::THRESHOLD_SHADER_PATH  = "./Assets/ShaderBin/PostProcess/bloom_threshold.frag.spv";
    const char* BloomMipChainEffect::DOWNSAMPLE_SHADER_PATH = "./Assets/ShaderBin/PostProcess/bloom_downsample.frag.spv";
    ...
    const std::string& BloomMipChainEffect::GetName() const
    {
        return EFFECT_NAME;
    }

    void BloomMipChainEffect::Init(PostProcessResourcePool& pool, PostProcessPipelineFactory& factory,
    ...
    void BloomMipChainEffect::Render(VulkanCommandBuffer* pCmdBuffer, vk::ImageView inputImageView,
    ...
    void BloomMipChainEffect::OnResize(PostProcessResourcePool& pool, PostProcessPipelineFactory& factory,
        uint32_t width, uint32_t height, vk::Format format)
    {
    ...
    void BloomMipChainEffect::Shutdown()
    {
