...
namespace Ailurus
{
	...
	{
		auto vkPhysicalDevice = VulkanContext::GetPhysicalDevice();
		auto vkSurface = VulkanContext::GetSurface();
		auto vkLogicalDevice = VulkanContext::GetDevice();
		auto graphicQueueIndex = VulkanContext::GetGraphicQueueIndex();
		auto presentQueueIndex = VulkanContext::GetPresentQueueIndex();
